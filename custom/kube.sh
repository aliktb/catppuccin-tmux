# credits to https://github.com/gabriellhrn
# https://github.com/gabriellhrn/catppuccin-tmux/blob/main/custom/kube.sh
show_kube() { # save this module in a file with the name <module_name>.sh
  ...
  local text="$(get_tmux_option "@catppuccin_kube_text" "$(bash ${SCRIPT_DIR}/../plugins/kube.tmux)")"
